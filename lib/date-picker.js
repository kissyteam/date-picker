...
var $ = require('node'),
    ...
    MonthPanel = require('./date-picker/month-panel');
var TapGesture = require('event-dom/gesture/tap');
var tap = TapGesture.TAP;
var KeyCode = $.Event.KeyCode;

var DateTimeFormat = require('gregorian-calendar-format'),
    PickerTpl = require('./date-picker/xtpl/picker-render');
 ...
 */
var DatePicker = module.exports = Control.extend({
...
var PopupPickerTpl = require('./date-picker/xtpl/popup-render'),
    Shim = require('component/extension/shim'),
    AlignExtension = require('component/extension/align');

/**
 * popup date picker ui component
 * @class Date.PopupPicker
 * @extends Component.Control
 * @mixins Component.Extension.Shim
 * @mixins Component.Extension.Align
 */
DatePicker.Popup = DatePicker.extend([Shim, AlignExtension], {
}, {
